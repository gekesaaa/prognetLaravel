...
<head>
  ...
  <link rel="stylesheet" href="css/styleFormData.css" />
...
<body>
  <section class="inputForm" id="inputForm">
    ...
    <div id="form" class="form mt-3 mb-5">
      <form action="/showdata" method="post" onsubmit="return validateForm();">
        @csrf
        <div class="container">
          <div class="row justify-content-center">
            <div class="col col-lg-6 p-5">
              ...
              <div class="mb-3 d-flex ms-3" id="jk">
                <div class="form-check">
                  <input class="form-check-input border-5" type="radio" name="gender" id="pria" value="pria" checked />
                  <label class="form-check-label" for="pria">Laki - Laki
                  </label>
                </div>

                <div class="form-check ms-5">
                  <input class="form-check-input border-5" type="radio" name="gender" id="wanita" value="wanita" />
