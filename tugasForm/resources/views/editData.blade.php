    ...
    <section class=" inputForm" id="inputForm">
        <div class="row justify-content-center">
            <div class="col col-lg-3 mt-lg-3">
                <h1 class="heading">Form <span>Edit Data</span></h1>
            </div>
        </div>

        <div id="form" class="form mt-3 mb-5">
            <form action="/update/{{$user->nim}}" method="post" onsubmit="return validateForm();">
                @csrf
                <div class="container">
                    <div class="row justify-content-center">
                        <div class="col col-lg-6 p-5">
                            ...
                            <div class="mb-3 d-flex ms-3" id="jk">
                                ...
                                <div class="form-check">
                                    <input class="form-check-input border-5" type="radio" name="jk" value="Pria" id="pria" required />
                                    <label class="form-check-label" for="pria">Laki - Laki
                                    </label>
                                </div>

                                <div class="form-check ms-5">
                                    <input class="form-check-input border-5" type="radio" name="jk" value="Wanita" id="wanita" required />
                            ...
                            <div class="mb-3 d-flex ms-3" id="sts">
                                <div class="form-check">
                                    <input class="form-check-input border-5" type="radio" name="status" value="Bekerja" id="menikah" required />
                                ...
                                <div class="form-check ms-5">
                                    <input class="form-check-input border-5" type="radio" name="status" value="Menikah" id="single" required />
                            ...
                            <div class="mb-3">
                                ...
                                <input type="email" class="form-control  @error('email') is-invalid @enderror" id="email" aria-describedby="emailHelp" name="email" value="{{ old('email',$user->email) }}" />
                                @error('email')
                                <div class="invalid-feedback">
                                    {{ $message }}
                                </div>
                            ...
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control" id="nomor  @error('nomor') is-invalid @enderror" name="nomor" value="{{ old('nomor',$user->nomor) }}" />
                                @error('nomor')
                                <div class="invalid-feedback">
                                    {{ $message }}
                                </div>
